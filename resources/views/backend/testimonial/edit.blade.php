                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" id="name"
                                                value="{{ $testimonial->name ?? old('name') }}" class="form-control"
                                                required>
                                            @error('name')
                                        ...
                                        <div class="form-group">
                                            <label for="description">Description <strong
                                                    class="text-danger">*</strong></label>
                                            <textarea name="description" id="description" rows="10" class="form-control editor" required>{{ $testimonial->description ?? old('description') }}</textarea>
                                            @error('description')
                                                <span class="text-danger" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="image" id="image" class="form-control dropify"
                                                data-default-file="{{ isset($testimonial->image) ? asset($testimonial->image) : '' }}"
                                                data-height="220">
                                            @error('image')
                                                <span class="text-danger" role="alert">
                                                    <strong>{{ $message }}</strong>

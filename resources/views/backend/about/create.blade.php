                        ...
                        <div class="row justify-content-center">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="about_title">About Us Title <strong
                                        ...
                                        <div class="form-group">
                                            <label for="mission_title">Our Mission Title <strong
                                                    class="text-danger">*</strong></label>
                                        ...
                                        <div class="form-group">
                                            <label for="about_description">Description <strong
                                                    class="text-danger">*</strong></label>
                                            <textarea name="about_description" id="about_description" rows="10" class="form-control editor" required>{{ old('about_description') }}</textarea>
                                        ...
                                        <div class="form-group">
                                            <label for="mission_description">Mission Description <strong
                                                    class="text-danger">*</strong></label>
                                            <textarea name="mission_description" id="mission_description" rows="10" class="form-control editor" required>{{ old('mission_description') }}</textarea>
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="image">About Attachment</label>
                                        ...
                                        <div class="form-group">
                                            <label for="image">Misson Attachment</label>
                                            <input type="file" name="mission_image" id="image"
                                                class="form-control dropify" data-height="220">
                                            @error('mission_image')
                                                <span class="text-danger" role="alert">
                                                    <strong>{{ $message }}</strong>

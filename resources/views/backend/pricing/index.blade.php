    ...
    <div class="page-heading">
        <div class="row">
            ...
            <div class="col-sm-6 pt-4 text-right">
                <a href="{{ route('pricing.create') }}" class="btn bg-primary text-white"><i class="fa fa-plus-circle"></i> Add
                    New</a>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center" width="12%">
                                            ...
                                            <form id="delete-form-{{ $pricing->id }}"
                                                action="{{ route('pricing.destroy', $pricing->id) }}" method="POST"

    ...
    <div class="page-heading">
        <div class="row">
            ...
            <div class="col-sm-6 pt-4 text-right">
                <a href="{{ route('pricing.index') }}" class="btn bg-danger text-white"><i class="fa fa-reply"></i> Back to
                    list</a>
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" id="title"
                                                value="{{ $pricing->title ?? old('title') }}" class="form-control" required>
                                            @error('title')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="price" id="price"
                                                value="{{ $pricing->price ?? old('price') }}" class="form-control" required>
                                            @error('price')
                                                <span class="text-danger" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="type" id="type"
                                                value="{{ $pricing->type ?? old('type') }}" class="form-control" required>
                                            @error('type')
                                                <span class="text-danger" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" id="description" rows="10" class="form-control editor" required>{{ $pricing->description ?? old('description') }}</textarea>
                                            @error('description')
                                                <span class="text-danger" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>

            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="card shadow">
                    <div class="card-title text-center border-bottom">
                        <a class="text-decoration-none" href="{{ url('admin/dashboard') }}">
                    ...
                    <div class="card-body">
                        ...
                        @if (Route::has('password.request'))
                            <p class="mt-3 login-form__footer">Forgot Your Password? <a
                                    href="{{ route('password.request') }}"
                                    class="text-secondary text-decoration-none">Click Here</a></p>
                        @endif
                    </div>
                </div>
            </div>

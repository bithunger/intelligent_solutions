            ...
            <div class="row align-items-center mt-30 mb-30">
                ...
                <div class="col-12 col-lg-6 col-sm-12 ">
                    <div class="welcome-meter mt-s wow fadeInUp" data-wow-delay="0.7s">
                        <img src="{{ asset($feature_details->image) }}" class="doted" alt="">
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6 offset-lg-0 col-md-10 offset-md-1">
                    <div class="who-we-contant mt-s">
                        ...
                        <h4 class="bl-text fadeInUp" data-wow-delay="0.3s">{{ $feature_details->title }}</h4>
                        <p class="fadeInUp" data-wow-delay="0.4s">{!! $feature_details->description !!}</p>
